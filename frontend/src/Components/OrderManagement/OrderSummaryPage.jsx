    ...
    (sum, order) =>
      ...
      toNumber(
        order.totalAmount ||
          order.total ||
          order.amount ||
          (order.orderDetails && order.orderDetails.total)
      ),
    0
  );
...
export default function OrderSummaryPage() {
  ...
  const handleDownloadCSV = () => {
    ...
    const orderRows = filteredOrders.map((o) => [
      ...
      o.status || "",
      toNumber(
        o.totalAmount || o.total || o.amount || (o.orderDetails && o.orderDetails.total)
      ),
    ...
    link.href = url;
    const fileName = `order-summary-${startDate || "all"}-to-${
      endDate || "all"
    }.csv`;
