...
const Sidebar = () => {
  ...
  return (
    <div className='relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-solid border-r-[1px] border-r-black border-t-0 border-l-0 border-b-0 text-sm'>
